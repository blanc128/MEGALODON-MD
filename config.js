...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~v4wkTQ4C#HpobGK4gq9gLWV38W_RIvxC2uP1VhwXxTehSWBvANII", // Your bot's session ID (keep it secure)
    ...
    DEV: process.env.DEV || "50941964977",                     // Developer's contact number
